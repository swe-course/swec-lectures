...
* Install additional plugins: 'GitHub Pull Request Builder', 'SonarQube Scanner for Jenkins', 'Pipeline Utility Steps', 'HTTP Request Plugin', 'Pipeline Maven Integration Plugin', **Installation via API doesn't work at current moment, plugins should be installed manually**
  ```
